...
margin-top:-47px;margin-left:-400px;width:800px;height:45px' name='keyword' placeholder='請輸入地區'
onfocus="placeholder= '' " onblur="placeholder='請輸入地區'" />
</div>
<div>
...
style='position:absolute;width:27px;height:27px;left:50%;top:50%;margin-top:-47px;
margin-left:368px '/>
</div>
<div>
<a href ='http://localhost:8080/Final_Project/TestProject'><img src="images/m_ing.gif" style='position:absolute;width:350px;height:150px;left:50%;top:59%;margin-top:-265px;
margin-left:-175px '></a>
</div>
</form>
</body>
