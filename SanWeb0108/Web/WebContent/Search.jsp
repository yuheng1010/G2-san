...
<div>
<a href ='http://localhost:8080/Final_Project/TestProject'><img src="images/m_ing.gif" 
...
margin-top:-47px;margin-left:-400px;width:800px;height:45px' name='keyword' placeholder='請輸入欲前往的地區'
onfocus="placeholder= '' " onblur="placeholder='請輸入欲前往的地區'" />
</div>
<div>
