...
public class WebTree {
	...
	public void setPostOrderScore(KeywordList keywords) throws IOException, ServletException{
		
		setPostOrderScore(root, keywords);
	}
	
	private void setPostOrderScore(WebNode startNode, KeywordList keywords) throws IOException, ServletException{
